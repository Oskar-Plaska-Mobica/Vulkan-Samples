...
Make sure you have VULKAN_SDK variable set in the system and pointing to your installation of Vulkan SDK.
____
...
Make sure you have VULKAN_SDK variable set in the system and pointing to your installation of Vulkan SDK and visible to Android Studio.
