...
{
    auto &feature = gpu.request_extension_features<VkPhysicalDeviceVulkan12Features>(VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COLOR_WRITE_ENABLE_FEATURES_EXT);
...
void ColorWriteEnable::setup_framebuffer()
{
    ...
    attachments[3] = depth_stencil.view;
