...
void ShaderObject::create_shaders()
{
	...
	vkb::HPPShaderCompiler glsl_compiler;
                             ...
                             const VkPushConstantRange   *pPushConstantRange)
{
	...
	//auto stageIt = shader_stage_map.find(shader_name_);
	/*
	if (!glsl_compiler.compile_to_spirv(vkb::find_shader_stage(shader_name), vert_glsl_source, "main", {}, spirv, info_log))
	{
